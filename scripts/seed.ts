...
const products = [
  ...
  },
  {
    ...
    category: 'electronics',
    images: ['https://via.placeholder.com/400?text=Smart+Watch'],
    stock: 30,
    sku: 'SWU-001',
    rating: 4.3,
  },
  {
    ...
    discountedPrice: 899,
    category: 'electronics',
    images: ['https://via.placeholder.com/400?text=Charger'],
    stock: 100,
    sku: 'USC-65W-001',
    rating: 4.6,
  },
  {
    ...
    category: 'electronics',
    images: ['https://via.placeholder.com/400?text=Webcam'],
    stock: 25,
    sku: '4KWC-001',
    rating: 4.4,
  },
  {
    ...
    category: 'electronics',
    images: ['https://via.placeholder.com/400?text=Keyboard+Mouse'],
    stock: 60,
    sku: 'WKM-001',
    rating: 4.2,
  },
  ...
  // Fashion
  {
    ...
    discountedPrice: 399,
    category: 'fashion',
    images: ['https://via.placeholder.com/400?text=T-Shirt'],
    stock: 200,
    sku: 'CTS-001',
    rating: 4.3,
  },
  {
    ...
    category: 'fashion',
    images: ['https://via.placeholder.com/400?text=Jeans'],
    stock: 80,
    sku: 'DNM-001',
    rating: 4.4,
  },
  {
    ...
    category: 'fashion',
    images: ['https://via.placeholder.com/400?text=Shoes'],
    stock: 120,
    sku: 'CAS-001',
    rating: 4.5,
  },
  {
    ...
    discountedPrice: 3499,
    category: 'fashion',
    images: ['https://via.placeholder.com/400?text=Jacket'],
    stock: 40,
    sku: 'WNJ-001',
    rating: 4.6,
  },
  {
    ...
    category: 'fashion',
    images: ['https://via.placeholder.com/400?text=Sneakers'],
    stock: 90,
    sku: 'SPN-001',
    rating: 4.4,
  },
  ...
  // Home & Furniture
  {
    ...
    images: ['https://via.placeholder.com/400?text=Office+Chair'],
    stock: 20,
    sku: 'OFC-001',
    rating: 4.5,
  },
  {
    ...
    category: 'home-furniture',
    images: ['https://via.placeholder.com/400?text=Dining+Table'],
    stock: 10,
    sku: 'DNT-001',
    rating: 4.3,
  },
  {
    ...
    discountedPrice: 999,
    category: 'home-furniture',
    images: ['https://via.placeholder.com/400?text=Bed+Sheets'],
    stock: 150,
    sku: 'BDS-001',
    rating: 4.4,
  },
  {
    ...
    discountedPrice: 599,
    category: 'home-furniture',
    images: ['https://via.placeholder.com/400?text=Wall+Lamp'],
    stock: 75,
    sku: 'WLP-001',
    rating: 4.3,
  },
  {
    ...
    discountedPrice: 6999,
    category: 'home-furniture',
    images: ['https://via.placeholder.com/400?text=Coffee+Table'],
    stock: 35,
    sku: 'CFT-001',
    rating: 4.2,
  },
  ...
  // Beauty & Personal Care
  {
    ...
    images: ['https://via.placeholder.com/400?text=Moisturizer'],
    stock: 200,
    sku: 'FMR-001',
    rating: 4.4,
  },
  {
    ...
    discountedPrice: 249,
    category: 'beauty-personal-care',
    images: ['https://via.placeholder.com/400?text=Shampoo'],
    stock: 300,
    sku: 'HSM-001',
    rating: 4.5,
  },
  {
    ...
    discountedPrice: 399,
    category: 'beauty-personal-care',
    images: ['https://via.placeholder.com/400?text=Sunscreen'],
    stock: 150,
    sku: 'SUN-50-001',
    rating: 4.6,
  },
  {
    ...
    discountedPrice: 179,
    category: 'beauty-personal-care',
    images: ['https://via.placeholder.com/400?text=Lip+Balm'],
    stock: 250,
    sku: 'LPB-001',
    rating: 4.3,
  },
  {
    ...
    discountedPrice: 299,
    category: 'beauty-personal-care',
    images: ['https://via.placeholder.com/400?text=Hair+Oil'],
    stock: 180,
    sku: 'HOL-001',
    rating: 4.4,
  },
  ...
  // Sports & Outdoors
  {
    ...
    images: ['https://via.placeholder.com/400?text=Yoga+Mat'],
    stock: 100,
    sku: 'YGM-001',
    rating: 4.4,
  },
  {
    ...
    discountedPrice: 6999,
    category: 'sports-outdoors',
    images: ['https://via.placeholder.com/400?text=Dumbbells'],
    stock: 30,
    sku: 'DBS-001',
    rating: 4.5,
  },
  {
    ...
    discountedPrice: 3499,
    category: 'sports-outdoors',
    images: ['https://via.placeholder.com/400?text=Running+Shoes'],
    stock: 60,
    sku: 'RNS-001',
    rating: 4.6,
  },
  {
    ...
    discountedPrice: 999,
    category: 'sports-outdoors',
    images: ['https://via.placeholder.com/400?text=Water+Bottle'],
    stock: 150,
    sku: 'SWB-001',
    rating: 4.3,
  },
  {
    ...
    discountedPrice: 9999,
    category: 'sports-outdoors',
    images: ['https://via.placeholder.com/400?text=Tent'],
    stock: 20,
    sku: 'CPT-001',
    rating: 4.4,
  },
